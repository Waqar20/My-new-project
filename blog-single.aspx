<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blog-single.aspx.cs" Inherits="projectE.blog_single" %>
        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="index.html" class="logo">N T B</a></h1>
              <ul>
                ...
                <li class="active"><a href="blog.aspx"><span><small>06</small>Blog</span></a></li>
                <li><a href="contact.aspx"><span><small>07</small>Contact</span></a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div id="colorlib-page">
      <header>
        <div class="colorlib-navbar-brand text-center">
          <a class="colorlib-logo" href="index.html">N T B</a>
        </div>
	      ...
	      <div class="container">
	        <div class="row">
	          <div class="col-md-8 ftco-animate">
	            ...
	            <p>
	              <img src="contant/images/image_6.jpg" alt="" class="img-fluid"/>
	            </p>
	            ...
	            <p>
	              <img src="contant/images/image_8.jpg" alt="" class="img-fluid"/>
	            </p>
	            ...
	            <div class="about-author d-flex p-5 bg-light">
	              <div class="bio align-self-md-center mr-5">
	                <img src="contant/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4"/>
	              </div>
	            ...
	            <div class="pt-5 mt-5">
	              ...
	              <ul class="comment-list">
	                <li class="comment">
	                  <div class="vcard bio">
	                    <img src="contant/images/person_1.jpg" alt="Image placeholder"/>
	                  </div>
	          ...
	          <div class="col-md-4 sidebar ftco-animate">
	            ...
	            <div class="sidebar-box ftco-animate">
	              ...
	              <div class="block-21 mb-4 d-flex">
	                <a class="blog-img mr-4" style="background-image: url(contant/images/image_1.jpg);"></a>
	                <div class="text">
	              ...
	              <div class="block-21 mb-4 d-flex">
	                <a class="blog-img mr-4" style="background-image: url(contant/images/image_2.jpg);"></a>
	                <div class="text">
	                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
	                  <div class="meta">
	                    <div><a href="#"><span class="icon-calendar"></span> July 12, 2018</a></div>
	              ...
	              <div class="block-21 mb-4 d-flex">
	                <a class="blog-img mr-4" style="background-image: url(contant/images/image_3.jpg);"></a>
	                <div class="text">
	                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
	                  <div class="meta">
	                    <div><a href="#"><span class="icon-calendar"></span> July 12, 2018</a></div>
